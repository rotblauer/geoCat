...
p2 <- ggplot(data = dfActivity,
             mapping = aes(x = date,
                           y = counts,
                           color = Name)) + geom_point(size=1) + scale_color_manual(values = colorVector) + theme(axis.text.x = element_text(angle = 90, hjust = 1)) + labs(x = "Counts per Day", y = "Number of Tracks")
...
p3 <- ggplot(data = sumByCatActivity,
             mapping = aes(x = Year_Month,
                           y = counts,
                           color = Name)) + geom_point(size=1) + scale_color_manual(values = colorVector) + theme(axis.text.x = element_text(angle = 90, hjust = 1)) + labs(x = "Counts per Day", y = "Number of Tracks")
p3 + facet_wrap( ~ Activity, scales = "free_y")
